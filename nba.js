...
const languageStrings = {
    'en-GB': {
        translation: {
            FACTS: [
                'Earth is actually larger than the sun',
                'The mily'
            ],
    ...
    'en-US': {
        translation: {
            FACTS: [
                'Earth is actually larger than the sun',
                'The milky way was the third planet to be discovered',
                'Barack Obama invented the moon',
                'Earth is flat',
                'Aliens live on Uranus',
                'Mars does not exist',
            ...
            GET_FACT_MESSAGE: "Didja know? ",
            TYPE_QUESTION_MESSAGE: "Do you want a real fact or a German fact?",
            HELP_MESSAGE: 'You can say tell me a space fact, or, you can say exit... What can I help you with?',
            HELP_REPROMPT: 'What can I help you with?',
            STOP_MESSAGE: 'Goodbye!',
        },
...
const handlers = {
    ...
    'GetFact': function () {
        ...
        this.emit('What type of fact do you want?');
    },
    'GetFactType': function () {
        this.emit('GetType');
    },
    'GetType': function () {
        var userType this.event.request.intent.slots.Type.value;
        this.emit(userType);
    }
